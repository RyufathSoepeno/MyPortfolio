...
.method static constructor <clinit>()V
    ...
    sput-object v0, Le/b;->b:Ljava/util/WeakHashMap;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Le/b;->c:Ljava/lang/Object;
...
.method private static a(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    sget-object v0, Le/b;->c:Ljava/lang/Object;

    monitor-enter v0

    :try_start_3
    sget-object v1, Le/b;->b:Ljava/util/WeakHashMap;
    ...
    invoke-direct {v1, p2, p0}, Le/b$a;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/Configuration;)V
...
.method private static b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    check-cast v2, Le/b$a;

    if-eqz v2, :cond_32

    iget-object v3, v2, Le/b$a;->b:Landroid/content/res/Configuration;
    ...
    iget-object p0, v2, Le/b$a;->a:Landroid/content/res/ColorStateList;
...
.method public static c(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_b
    invoke-static {p0, p1}, Le/b;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_12
    invoke-static {p0, p1}, Le/b;->f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    if-eqz v0, :cond_1c

    invoke-static {p0, p1, v0}, Le/b;->a(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
...
.method private static f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, p1}, Le/b;->g(Landroid/content/Context;I)Z
...
.method private static g(Landroid/content/Context;I)Z
    ...
    invoke-static {}, Le/b;->e()Landroid/util/TypedValue;
