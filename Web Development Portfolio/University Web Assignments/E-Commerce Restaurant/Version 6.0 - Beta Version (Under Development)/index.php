...
// Fetch the top 6 products. This is similar with ORM
    ...
    <header>
        <nav>
            ...
            <ul class="nav-links">
                ...
                <li><a href="http://localhost/Web Prog Final/store.php" style="color: white;">Menu</a></li>
                <li><a href="http://localhost/Web Prog Final/index.html" style="color: white;">Login</a></li>
            </ul>
        </nav>
    </header>
