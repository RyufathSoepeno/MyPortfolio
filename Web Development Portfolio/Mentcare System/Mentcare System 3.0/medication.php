...
<body>
    ...
    <form method="GET" action=""> <!-- Search Bar -->
        <input class= "searchbar" type="text" name="search" placeholder="Search medication...">
    ...
    <br>
        ...
        $sql = "SELECT * FROM medications WHERE name LIKE '%$searchQuery%' OR class LIKE '%$searchQuery%' OR manufacturer LIKE '%$searchQuery%'";
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td>" . $row["comment"]. "</td>
                        <td><a href='http://localhost/php-projects/MedicationInformation.php?id=" . $row["id"] . "'>More Info</a></td>
                    </tr>";
            }
