...
<body>
    ...
    <form method="GET" action="">
        <input class="searchbar" type="text" name="search" placeholder="Search patient...">
        <button class="searching" type="submit">Search</button>
    </form>
    ...
    <table>
        ...
        <?php
            ...
            */
            ...
            // Handle GET request to display patient list
            $searchQuery = isset($_GET['search']) ? $_GET['search'] : '';

            $sql = "SELECT * FROM patients WHERE full_name LIKE '%$searchQuery%' OR birth_place LIKE '%$searchQuery%' OR email LIKE '%$searchQuery%'";
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    echo "<tr>
                            ...
                            <td>" . $row["telephone"]. "</td>
                            <td>" . $row["email"]. "</td>
                            <td><img src='" . $row["image"]. "' alt='Patient Image'></td>
                            <td><a href='http://localhost/php-projects/PatientInformation.php?id=" . $row["id"] . "'>More Info</a></td>
                        </tr>";
                }

                echo "</table>";
            } else {
                echo "<p class='message'>No patients found</p>";
            }
